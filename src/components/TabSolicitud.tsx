...
import { WelcomeSolicitud } from "./sample/WelcomeSolicitud";
...
export default function TabSolicitud() {
  ...
  let rolusuario: any = rolespecifico;
  ...
  return (
    <div className={themeString === "default" ? "" : "dark"}>
      ...
      <WelcomeSolicitud rolespecifico={rolespecifico} showFunction={showFunction} /> :
      {/* <Permisos /> */}
